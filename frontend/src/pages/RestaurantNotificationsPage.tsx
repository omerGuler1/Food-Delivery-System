...
import { getRestaurantReceivedMessages, markMessageAsRead, deleteMessage } from '../services/messageService';
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      try {
        ...
        if (restaurantId) {
          const fetchedMessages = await getRestaurantReceivedMessages(restaurantId);
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          View messages, requests, and notifications from users and admins.
        </Typography>
