...
import { getCourierReceivedMessages, markMessageAsRead, deleteMessage } from '../services/messageService';
    ...
    const fetchMessages = async () => {
      ...
      try {
        ...
        if (courierId) {
          ...
          const fetchedMessages = await getCourierReceivedMessages(courierId);
